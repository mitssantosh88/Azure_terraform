...
function runArgsSanitizerTests() {
    [
        ...
        it(`Should return '${input}' with no replacement.`, () => {
            const [result] = (0, argsSanitizer_1.sanitizeArgs)(input, { argsSplitSymbols: '``' });
    ...
    it('Should use input reg exp', () => {
        ...
        const [result] = (0, argsSanitizer_1.sanitizeArgs)(input, { argsSplitSymbols: '``', saniziteRegExp: regx });
        assert.equal(result, expected);
    });
    it('Throws error if \'global\' flag not set', () => {
        const regx = /1/;
        assert.throws(() => (0, argsSanitizer_1.sanitizeArgs)('1', { argsSplitSymbols: '``', saniziteRegExp: regx }));
    });
}
...
// SIG // meL7neOigghfkA4VYqqcErQRaziMY7kHdD6dQW0UDVug
...
// SIG // Lk+AD1sP3b1Cx2eMuJnXIuVWj1WltjgJk+GXoaqRxDBC
// SIG // BgorBgEEAYI3AgEMMTQwMqAUgBIATQBpAGMAcgBvAHMA
// SIG // bwBmAHShGoAYaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
// SIG // MA0GCSqGSIb3DQEBAQUABIIBACsoSFd2MYIfN2zMkl58
// SIG // KNNwZXG4fyMTZ7/7zaCWaDfINTyEmyH2rahTp/27+wlQ
// SIG // dF40N004vnySlsHiJW3xiSazE4iPco5Jk0rNb+tSwl9w
// SIG // axDq0madG9nl/buEICFyd4tQR0dGTNJgJdCCWgpExahz
// SIG // 9rRnzqlbbOj4WlT+wnlfxxhj8Dk+Aa+Yj0MXS4pFSgp2
// SIG // GnWhVH/8+tYPWVOfIVhWsFWxTA9aTMrcbioOD3C7DROC
// SIG // qxZb9TVneDOpJyQ+ONfttNsHgsMdW4oaXDy2H8iKovJD
// SIG // iSAlD4BeEALy0K5ofSYrBy6kgRzaDFcXQeqTn3pTXk/E
// SIG // ObTcnqnoxFk2MuKhgheXMIIXkwYKKwYBBAGCNwMDATGC
...
// SIG // ZQMEAgEFAAQgv0NZyzNnyjMmPAOgtinmRp3KR4TzIyUN
// SIG // 3GX7FSdKg9QCBmqFMC9UvhgTMjAyNjA4MjQwNTI4NDQu
...
// SIG // MjAxMDANBgkqhkiG9w0BAQsFAAIFAO42RWowIhgPMjAy
// SIG // NjA4MjQwNDIyMDJaGA8yMDI2MDgyNTA0MjIwMlowdzA9
// SIG // BgorBgEEAYRZCgQBMS8wLTAKAgUA7jZFagIBADAKAgEA
// SIG // AgIUcQIB/zAHAgEAAgITNjAKAgUA7jeW6gIBADA2Bgor
// SIG // BgEEAYRZCgQCMSgwJjAMBgorBgEEAYRZCgMCoAowCAIB
// SIG // AAIDB6EgoQowCAIBAAIDAYagMA0GCSqGSIb3DQEBCwUA
// SIG // A4IBAQAoxJtCZlAmZxfRIs9fnXpYg2g/blyr4p0CSJXt
// SIG // e2hLfwaGZ6WdBrFF9MimtHjC36x4Wyh7HPqO5vs10Bjv
// SIG // O0+L2EzDHgLgGLuC1SqKuYWxHx9I/5Lk5EV+qqPa48zm
// SIG // tFvFpmlnfITNaPgHZN+Iiis37I9rdoF48bnoleAOIF3g
