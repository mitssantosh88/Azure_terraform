...
exports.shellSplit = exports.neutralizeCommandSubstitution = exports.shellQuote = void 0;
 ...
 */
function neutralizeCommandSubstitution(value) {
    if (!value)
        return value;
    return value.replace(/\\|`|\$\(|;|\r\n|\r|\n|\||<|>|&|\(|\)|#|'|"| |\t/g, (match) => {
        if (match in SPECIAL_SEQUENCES)
            return SPECIAL_SEQUENCES[match];
        if (SHELL_META_CHARS.has(match))
            return '\\' + match;
        return match;
    });
}
exports.neutralizeCommandSubstitution = neutralizeCommandSubstitution;
/**
 * @example
...
function shellSplit(value) {
    ...
    while ((match = tokenRegex.exec(value)) !== null) {
        const token = match[0]
            .replace(/'([^']*)'/g, '$1')
            .replace(/"((?:[^"\\]|\\.)*)"/g, (_, content) => content.replace(/\\([$`"\\]|\n)/g, '$1'))
            .replace(/\\(.)/g, '$1');
        tokens.push(token);
    }
    return tokens;
...
// SIG // HwE9JbmzFqbpxIw1hKsjSh8JaQsNb8WKUnTAcue0d7Sg
...
// SIG // sACs+/otOK0CFgZlpfsvIGAW3nfvar9lwYXHjsjwezBC
// SIG // BgorBgEEAYI3AgEMMTQwMqAUgBIATQBpAGMAcgBvAHMA
// SIG // bwBmAHShGoAYaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
// SIG // MA0GCSqGSIb3DQEBAQUABIIBABtKOtBeYprPkP3sA6NJ
// SIG // R9GWAtfZ5vsO0gfH0eEqSaWMK4pawuRExZreOg7NPV+l
// SIG // W453pyykzDebyQ2yCVoBRu8E4fwWGufuZAbeAzxwXNdn
// SIG // 6nYUsfIH5WxCCg1qFvk76Vx2l+CeqIbl+oBiC9fmMYSh
// SIG // rMLPIgroNKSnJKwZ2w1taXoitTvx2e9iCZTDbahGgKWs
// SIG // B/FySc8nofvtL6KwgLhVtY7wwuhaQVnlhLtMCRvJZRvH
// SIG // AlgLvF2vhwItqkc5hljWKxhIdeqw+Ot8mfeue3ci8SSa
// SIG // gElvc/alQKMU19y6xs1KbAAvBJx5n+FDlG3qZ0m+PWbw
// SIG // IkCDslBiZKs6xPyhgheUMIIXkAYKKwYBBAGCNwMDATGC
...
// SIG // ZQMEAgEFAAQgmINvyVAF81BNkXDZkT4A6AJHCXpj40nr
// SIG // jQrkq7uIc2kCBmqFjI+lNhgTMjAyNjA4MjQwNTI5NDUu
// SIG // MTcxWjAEgAIB9KCB0aSBzjCByzELMAkGA1UEBhMCVVMx
...
// SIG // MjAxMDANBgkqhkiG9w0BAQsFAAIFAO41+RgwIhgPMjAy
// SIG // NjA4MjMyMjU2MjRaGA8yMDI2MDgyNDIyNTYyNFowdDA6
// SIG // BgorBgEEAYRZCgQBMSwwKjAKAgUA7jX5GAIBADAHAgEA
// SIG // AgIZHDAHAgEAAgISYDAKAgUA7jdKmAIBADA2BgorBgEE
